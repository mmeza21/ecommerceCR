...
$datos3 = $conexion->query("select productos_venta.*,productos.imagen
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">CP <?php echo $datosEnvio[4]; ?> </label>
                  </div>
                </div>
          ...
          <div class="col-md-5 ml-auto">
            ...
            <div class="p-4 border mb-3">
              ...
              <span class="d-block text-primary h6 text-uppercase"><?php echo $f['nombre'] ?></span><br>
