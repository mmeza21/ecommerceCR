<header class="site-navbar" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
              <form action="./busqueda.php" class="site-block-top-search" method="GET"> <!-- busqueda -->
    ...
    <div class="bg-warning py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="default.php">Inicio</a> <span class="mx-2 mb-0">/</span>
           <strong class="text-black"><a href="index.php">Comprar</a></strong></div>
        </div>
      </div>
    </div>